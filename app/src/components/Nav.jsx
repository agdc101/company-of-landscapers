...
const Nav = (props) => {
    ...
    return (
        <motion.header className="flex justify-between items-center pl-4 pr-2 md:pl-6 lg:px-8 z-30 h-20 xl:h-20 fixed text-white w-full" style={{ backgroundColor: props.isMainNav ? backgroundColor : 'rgb(84, 111, 104)', boxShadow: boxShadow  } }>
