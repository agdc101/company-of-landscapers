        ...
        <section className="bg-black hero">
            <motion.div className="overlay-content inset-0 z-10 relative px-6 lg:px-10 w-full" {...framerAnimations.slideRightFadeIn}>
                <div className="absolute top-40 sm:top-40 w-2/3 2xl:w-1/2" >
                    <h2 className="leading-relaxed text-white text-5xl sm:text-6xl md:text-7xl xl:text-8xl font-light tracking-wider my-6 lg:my-18">{title}</h2>
                    ...
                    <Link to={'/about'} className="border-solid border-2 border-white rounded text-white font-bold absolute text-base p-3 md:text-lg mt-8 md:mt-12 w-1/2 lg:w-1/3 text-center">Learn more</Link>
                </div>
            </motion.div>
