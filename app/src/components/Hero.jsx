        ...
        <section className="bg-black hero">
            <motion.div {...framerAnimations.slideRightFadeIn}>
                <div className="overlay-content inset-0 z-10 relative px-6 md:px-12 lg:px-20 xl:px-32 w-full">
                    <div className="absolute top-36 sm:top-44 xl:top-52 w-2/3 2xl:w-1/2" >
                        <h3 className="leading-relaxed text-white text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-light tracking-wider md:my-6 lg:my-18">{title ? title : 'Projects'}</h3>
                    </div>
                </div>
